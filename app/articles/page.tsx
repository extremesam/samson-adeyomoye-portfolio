...
export default function ArticlesPage() {
  ...
  const articles = [
    ...
    {
      id: 2,
      title: "How GIS and Remote Sensing are Helping to Fight Wildfires in Canada",
      category: "Natural Disasters",
      description: "GIS and Remote Sensing approach in tackling wildfires related disaster in canada",
    ...
    },
    {
      ...
      description: "Advanced techniques Air Quality parameters across the world",
